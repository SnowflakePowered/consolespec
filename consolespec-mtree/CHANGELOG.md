...
- Parse SHA-1 digests and the standard `md5`, `sha1`, and `sha256` property names.
...
- *(i18n)* Consolidate per-language Fluent files
- Canonicalize error variants

## [0.3.2] - 2026-01-11

### Other

- *(README)* Add introduction and use "command line interface"
